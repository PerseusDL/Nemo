...
nemo = Nemo(
    ...
    chunker={
        ...
        "urn:cts:froLit:jns915.jns1856.ciham-fro1": lambda text, cb: [(reff.split(":")[-1], reff.split(":")[-1]) for reff in getLevel(1)],
        "urn:cts:latinLit:phi0917.phi001.perseus-lat2": lambda text, cb: [(reff.split(":")[-1], reff.split(":")[-1]) for reff in getLevel(1)],
